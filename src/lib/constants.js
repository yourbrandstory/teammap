...
export const NAV_ICONS = { tkd:'📊', tg2:'🔄', lu:'📋', lv:'☷', tk:'☰', ms:'◆', sc:'🗓️', sg:'📡', td:'▣', bl:'◯', pg:'◢', kb:'📌', st:'⚙', dl:'📤' };

export const DEFAULT_NAV_ORDER = ['tkd','tg2','lu','lv','tk','ms','sc','sg','dl','td','bl','pg','st'];
export const DEFAULT_NAV_LABELS = {
  tkd:'Task Dashboard', tg2:'Routines', lu:'Line Up', lv:'List View',
  tk:'Tasks & Milestones', ms:'Milestones', sc:'SM Calendar', sg:'Signal', dl:'Delegated', td:'Team Dashboard', bl:'Builder',
